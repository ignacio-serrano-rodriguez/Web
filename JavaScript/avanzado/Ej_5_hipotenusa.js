...
Escribe una función llamada calcularHipotenusa que reciba la longitud de los dos catetos de un triángulo rectángulo y
devuelva la longitud de la hipotenusa. Comprueba que los datos recibidos sean los adecuados.
*/

function calcularHipotenusa(cateto_1, cateto_2) 
{
    let cadenaResultado = "longitud de la hipotenusa: ";
