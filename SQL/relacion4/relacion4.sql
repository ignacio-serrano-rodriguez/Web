...
/* 2. Mostrar los datos de los empleados que tengan el mismo oficio que ʻCEREZOʼ. 
El resultado debe ir ordenado por apellido. */


/* 3. Mostrar los empleados (nombre, oficio, salario y fecha de alta) que desempeñen 
el mismo oficio que ʻJIMÉNEZʼ y que tengan un salario mayor o igual que ʻFERNÁNDEZʼ. */
